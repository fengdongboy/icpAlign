...
namespace trimesh
{
	...
	//	int idx1, idx2;
	//	PtPair(const trimesh::point &p1_, const trimesh::vec &n1_, const int idx1_,
	//		const trimesh::point &p2_, const trimesh::vec &n2_, const int idx2_) :
	//		p1(p1_), n1(n1_), p2(p2_), n2(n2_), idx1(idx1_), idx2(idx2_)
	//	{}
	//	PtPair()
	//	{}
	//};
